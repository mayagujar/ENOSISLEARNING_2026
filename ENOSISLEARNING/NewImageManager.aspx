...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
          ...
          <div class="vacancy-top-tab" style="height:70px">
            ...
            <td class="text-center" style="border-radius:50px;width:150px;border:none;">
     <asp:TextBox ID="txtdocname" runat="server" placeholder="Search_Image_Name" Style="border-radius:15px; text-align:center;border-style: none;
      " Height="35px"></asp:TextBox>
           ...
           <td style="border-radius:50px;border-style: none;">
                ...
                <a id="btnRDemo" href="#" class="btn btn-danger br" style="height:35px;box-shadow: 1px 1px 3px 1px gray;position:relative;right:42%;" data-toggle="modal" data-target="#myImgModal"  target="_parent"> <img src="../img/Add4.png" height="25" title="Add" />ADD NEW Image</a> 
         </td>
        </tr>
            </table>
            ...
            <!-- Modal Dialog -->
     <div id="myImgModal" clientidmode="Static" class="modal fade" data-backdrop="false"  role="dialog" style="background-color:#ddd;">
        <div class="modal-dialog custom-modal-width modal-dialog-centered" >
            <div class="modal-content br" style="max-height:50vh;">
                ...
                <div class="modal-body" style="height:100%;">
                     <h4 class="modal-title display-5" style="text-align: center;color: #1d96b2;">Add New Image</h4>
...
" />
 ...
 <div class="containerr hidden">
    ...
    <asp:GridView ID="GridView1"  runat="server" AutoGenerateColumns="false" DataKeyNames="imgId" OnRowCommand="GridView1_RowCommand" OnRowEditing="GridView1_RowEditing" class="gridview-area" 
         ...
         <PagerStyle HorizontalAlign="Right" CssClass="GridPager" BorderStyle="Solid" ForeColor="black"/>
              <Columns>
                  ...
                  <asp:TemplateField HeaderText="Image Name"  HeaderStyle-Font-Bold="true" HeaderStyle-CssClass="gridview-header" FooterStyle-BorderStyle="None" ItemStyle-BorderStyle="None" HeaderStyle-BorderStyle="None" ItemStyle-HorizontalAlign="Center">
                         <ItemTemplate>
                  ...
                  <asp:TemplateField HeaderText="Path"  HeaderStyle-Font-Bold="true" HeaderStyle-CssClass="gridview-header" FooterStyle-BorderStyle="None" ItemStyle-BorderStyle="None" HeaderStyle-BorderStyle="None" ItemStyle-HorizontalAlign="Center">
                         <ItemTemplate>
                  ...
                  <asp:TemplateField HeaderText="Action"  HeaderStyle-Font-Bold="true" HeaderStyle-CssClass="gridview-header" FooterStyle-BorderStyle="None" ItemStyle-BorderStyle="None" HeaderStyle-BorderStyle="None" ItemStyle-HorizontalAlign="Center">
                         <ItemTemplate>
